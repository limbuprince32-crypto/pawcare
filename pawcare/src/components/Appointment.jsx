...
const Appointment = () => {
  ...
  return (
    ...
    >
      <div className="max-w-5xl w-full bg-gray-50 rounded-3xl shadow-2xl overflow-hidden md:flex">
        <div
        ...
        >
          ...
          <div className="relative h-full flex flex-col justify-end p-8 bg-linear-to-t from-green-700/40 to-transparent text-white">
            ...
            <p className="text-green-100 italic">
              ...
              explicabo labore nobis blanditiis facilis neque earum veritatis,
              accusantium illum enim ipsum, soluta nesciunt vero at ipsa, ex
              doloremque minima officiis?
            </p>
        ...
        >
          <header className="mb-8">
            ...
            <p className="text-gray-500 mt-2">
              ...
              magni libero. Debitis accusantium, facilis similique nisi aut
              veritatis eaque iure.
            </p>
          </header>
